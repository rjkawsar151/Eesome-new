...
@section('content')
<div class="page-head" style="margin-bottom:1rem"><div><h1 class="title">Shipping methods</h1><p class="subtle">Control delivery pricing and availability.</p></div><a class="btn btn-primary" href="{{ route('admin.shipping-methods.create') }}">Add method</a></div>
