...
@section('content')
<div style="display:flex;justify-content:space-between;align-items:center"><div><h1 class="title">Coupons</h1><p class="subtle">Server-validated checkout discounts.</p></div><a class="btn btn-primary" href="{{ route('admin.coupons.create') }}">Add coupon</a></div>
