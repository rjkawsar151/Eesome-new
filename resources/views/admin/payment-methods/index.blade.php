...
@section('content')
<div class="page-head" style="margin-bottom:1rem"><div><h1 class="title">Payment methods</h1><p class="subtle">Manage the options customers see at checkout.</p></div><a class="btn btn-primary" href="{{ route('admin.payment-methods.create') }}">Add method</a></div>
