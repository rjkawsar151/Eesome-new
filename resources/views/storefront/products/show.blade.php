...
.buybox{display:flex;gap:.75rem;margin:1.5rem 0;position:relative;z-index:5}.buybox input[type=number]{width:80px;border:1px solid #d1d5db;border-radius:10px;padding:.75rem}.buybox button{border:0;border-radius:10px;background:var(--brand-600);color:#fff;font-weight:800;padding:.8rem 1.5rem;cursor:pointer;transition:all .2s}.buybox button[name="buy_now"]{background:#e1d0f0;color:#1e1b4b;border:1px solid rgba(190,24,93,.18)}.buybox button[name="buy_now"]:hover{background:#d4bee8;color:#1e1b4b;border-color:rgba(190,24,93,.3)}
